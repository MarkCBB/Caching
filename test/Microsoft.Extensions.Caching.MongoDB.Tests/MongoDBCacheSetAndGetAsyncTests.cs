...
namespace Microsoft.Extensions.Caching.MongoDB
{
    public class MongoDBCacheSetAndGetAsyncTests : BaseMongoDbTests
    {
        ...
        public virtual async void MongoDBCache_AbsoluteExpiration_Is_Before_Sliding_So_Effective_Should_Be_AbsoluteExpiration()
        {
            // Arrange
        ...
        [Fact(Skip = SkipReason)]
        public virtual async void MongoDBCache_AbsoluteExpiration_Is_After_Sliding_So_Effective_Should_Be_Sliding()
        {
            // Arrange
            var utcNow = DateTimeOffset.UtcNow;
            var options = new DistributedCacheEntryOptions()
        ...
        [Fact(Skip = SkipReason)]
        public virtual async void MongoDBCache_AbsoluteExpirationRelativeToNow_Is_Before_Sliding_So_Effective_Should_Be_AbsoluteExpiration()
        {
            // Arrange
            var utcNow = DateTimeOffset.UtcNow;
            var options = new DistributedCacheEntryOptions()
        ...
        [Fact(Skip = SkipReason)]
        public virtual async void MongoDBCache_AbsoluteExpirationRelativeToNow_Is_After_Sliding_So_Effective_Should_Be_Sliding()
        {
            // Arrange
            var utcNow = DateTimeOffset.UtcNow;
            var options = new DistributedCacheEntryOptions()
        ...
        [Fact(Skip = SkipReason)]
        public virtual async void MongoDBCache_Getting_a_non_existing_key_should_be_null()
        {
            // Arrange
        ...
        [Fact(Skip = SkipReason)]
        public virtual async void MongoDBCache_Refreshing_a_non_existing_key_should_be_null()
        {
            // Arrange
        ...
        [Fact(Skip = SkipReason)]
        public virtual async void MongoDBCache_Set_the_same_key_twice_should_get_the_last_value()
        {
            // Arrange
            var utcNow = DateTimeOffset.UtcNow;
            var options = new DistributedCacheEntryOptions()
        ...
        [Fact(Skip = SkipReason)]
        public virtual async void MongoDBCache_old_documents_are_deleted_if_Delete_old_values_is_true()
        {
            // Arrange
            var utcNow = DateTimeOffset.UtcNow;
            var options = new DistributedCacheEntryOptions()
        ...
        [Fact(Skip = SkipReason)]
        public virtual async void MongoDBCache_documents_not_old_are_not_deleted_if_Delete_old_values_is_true()
        {
            // Arrange
            var utcNow = DateTimeOffset.UtcNow;
            var options = new DistributedCacheEntryOptions()
