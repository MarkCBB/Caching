...
{
    public class MongoDBCacheSetAndGetTestsWithMongoSettings : MongoDBCacheSetAndGetTests
    {
        // this derivated constructor will override the property options
        // property set by BaseMongoDbTests
        public MongoDBCacheSetAndGetTestsWithMongoSettings()
        {
